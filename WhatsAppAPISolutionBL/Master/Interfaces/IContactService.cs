...
namespace WhatsAppAPISolutionBL.Master.Interfaces
{
    public interface IContactService
    {
        ...
        Task<UResponse> AddContactAsync(int clientId, int userId, ContactDto contact);
        Task<UResponse> UpdateContactAsync(int userId, ContactDto contact);
        Task<UResponse> DeleteContactAsync(int ContactId);
        Task<UResponse> ImportBulkContacts(int clientId, int userId, ImportContactDto model);
