...
namespace WhatsAppAPISolutionBL.Master.Interfaces
{
    public interface ISystemActionsService
    {
        ...
        Task<UResponse> AddSystemActionsAsync(int clientId, int userId, SystemActionsDto systemActions);
        Task<UResponse> UpdateSystemActionsAsync(int clientId, int userId, SystemActionsDto systemActions);
