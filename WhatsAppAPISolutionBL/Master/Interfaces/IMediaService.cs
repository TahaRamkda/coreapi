...
namespace WhatsAppAPISolutionBL.Master.Interfaces
{
    ...
    {
        Task<List<UMediaUpload>> GetMediaListAsync(int clientId, int senderId = 0, string FileName= "",  string contentTypeStr = "", int pageNo = 0, int pageSize = int.MaxValue, int mediaTypeId = 0);
